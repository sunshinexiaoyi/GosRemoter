...
public abstract class ReuseAdapter<T> extends BaseAdapter {
    ...
    public ReuseAdapter(int mLayoutRes) {
        this.mLayoutRes = mLayoutRes;
    }

    public ReuseAdapter(ArrayList<T> mData, int mLayoutRes) {
        this.mData = mData;
        this.mLayoutRes = mLayoutRes;
    }
    ...
    public static class ViewHolder {
        ...
        public ViewHolder setColor(int id) {
            ...
            if (selectedPosition  == getItemPosition()) {
                view.setBackgroundResource(R.color.deepgray);
